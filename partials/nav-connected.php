<header class="f-header position-relative js-f-header">
    <div class="f-header__mobile-content container max-width-lg">
        <a href="../layout.php" class="f-header__logo">
    ...
    <div class="f-header__nav" role="navigation">
        <div class="f-header__nav-grid container max-width-lg">
            ...
            <ul class="f-header__list">
                <li class="f-header__item"><a href="../layout.php" class="f-header__link">Home</a></li>
                <li class="f-header__item">|</li>
                <li class="f-header__item"><a href="#0" class="f-header__link">Find a Yacht</a></li>
                <li class="f-header__item">|</li>
                ...
                <li class="f-header__item">|</li>
                <li class="f-header__item"><a href="#0" class="f-header__link">Legal mentions</a></li>
            </ul>

            <ul class="f-header__list margin-left-auto@md">
                <li class="f-header__item"><a href="#0" class="f-header__btn btn btn--primary btn--border book-yacht">Book a Yacht</a></li>
            </ul>
                <nav class="dropdown js-dropdown margin-left-auto@md">
                    <ul>
                        <li class="dropdown__wrapper">
                            <a href="#0" class="dropdown__trigger f-header__btn btn btn--border">
                            Matthias
                            <svg aria-hidden="true" class="icon margin-left-xxxs" viewBox="0 0 16 16">
                            ...
                            <ul class="dropdown__menu" aria-label="submenu">
                                ...
                                <li><a href="#0" class="dropdown__item">INVOICES</a></li>
                                <li><a href="#0" class="dropdown__item">YACHT'S SHEET</a></li>
                                <li><a href="#0" class="dropdown__item">DISCONNECT</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>

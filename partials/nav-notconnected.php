  ...
  <div class="f-header__nav" role="navigation">
    <div class="f-header__nav-grid container max-width-lg">
      ...
      <ul class="f-header__list">
        ...
        <li class="f-header__item"><a href="../pages/home" class="f-header__link">Find a Yacht</a></li>
        <li class="f-header__item">|</li>
      ...
      <ul class="f-header__list margin-left-auto@md">
        <li class="f-header__item"><a href="#0" class="f-header__btn btn btn--primary btn--border">Book a Yacht</a></li>
      </ul>
    </div>
  </div>
</header>